...
@Database(
    entities = [NoteRelation::class, NoteTermFrequency::class, NoteOcrText::class, AtomicNoteEntity::class, SmartBookEntity::class, SmartBookPage::class, HandwrittenNoteEntity::class, TextNoteEntity::class, QueryEntity::class

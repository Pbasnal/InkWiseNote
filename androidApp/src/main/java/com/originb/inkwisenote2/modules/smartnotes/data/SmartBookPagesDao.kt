...
interface SmartBookPagesDao {
    ...
    fun getSmartBookPagesOfNote(noteId: Long): MutableList<SmartBookPage>

    @Query("SELECT * FROM smart_book_pages WHERE note_id In (:noteIds)")
    fun getSmartBookPagesOfNote(noteIds: MutableSet<Long>): MutableList<SmartBookPage>
    ...
    fun getSmartBooksPages(bookIds: MutableSet<Long>): MutableList<SmartBookPage>
    ...
    @Update
    fun updateSmartBookPage(smartBookEntity: MutableList<SmartBookPage>): Int

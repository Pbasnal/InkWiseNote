...
//            return InitNoteFragment.newInstance(-1, null, this);
//        }
//
...
//            return TextNoteFragment.newInstance(bookId, atomicNote);
//        } else if (NoteType.HANDWRITTEN_PNG.toString().equals(atomicNote.getNoteType())) {
//            return HandwrittenNoteFragment.newInstance(bookId, atomicNote);
//        } else {
